...
dotenv_1.config({ path: path_1.default.resolve(__dirname, '..', 'deployment', 'environment', '.env') });
// Dependencies
...
var authorize_twitter_1 = require("./routes/authorize_twitter");
// Other
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                router.get('/test', function (ctx) { ctx.body = 'cake'; });
                router.post('/example', example_1.default);
                router.get('/twitter/connect', authorize_twitter_1.twitterConnect);
                router.get('/twitter/callback', authorize_twitter_1.twitterCallback);
                return [4 /*yield*/, cron_1.default()];
            case 1:
                _a.sent();
                app.keys = [process.env.SIGNING_COOKIE_KEYS];
                app
                    ...
                    .use(koa_static_1.default(path_1.default.resolve(__dirname, 'server', 'static')))
                    .listen(7777);
                return [2 /*return*/];
        }
    });
